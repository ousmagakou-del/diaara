...
export default function Onboarding({ onComplete }) {
  ...
  const [step, setStep] = useState('intro'); // intro | auth | done
  ...
  const handleGoogle = async () => {
    ...
    try {
      ...
      setError('Google OAuth non configuré. Utilise email/password.');
    }
  };
      ...
      <div className="ob-auth-screen page-anim">
        ...
        <div className="ob-auth-bottom">
          ...
          <div className="phone-input-wrap">
            ...
            <input className="phone-input" type="password" value={password} onChange={e => setPassword(e.target.value)} placeholder="••••••" />
          </div>
          ...
          <p style={{ textAlign: 'center', marginTop: 18, fontSize: 12, color: 'var(--ink-soft)' }}>
            ...
            <button
              ...
              style={{ color: 'var(--primary)', fontWeight: 600, textDecoration: 'underline', padding: 0 }}
            >
